...
function Quran_template($text='', $sora='', $ayatrans='') {
...
function Quran_template2($text='', $sora='', $ayatrans=''){
	return sprintf('<table width="%s" border="0" class="aya_display" dir="ltr" cellpadding="0" cellspacing="0">
			<tr>
...
function Quran_template3($text='', $sora='', $ayatrans=''){
	return sprintf('<table width="%s" border="0" class="aya_display" dir="ltr" cellpadding="0" cellspacing="0">
			<tr>
...
function Quran_template4($text='', $sora='', $ayatrans=''){
	return sprintf('<table width="%s" border="0" class="aya_display" dir="ltr" cellpadding="0" cellspacing="0">
			<tr>
